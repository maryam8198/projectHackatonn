                                               ...
                                               <?php
                                                    ...
                                                    while ($row = mysqli_fetch_array($query)) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <img src="../images/<?php echo $row['products_image']?>" alt="<?php echo $row['products_name']?>" width="80px" id="productsimg">
                                                            </td>
                                                            <td><a class="btn" href="edit_product.php?id=<?php echo $row['id'] ?>">ویرایش</a> -
                                                                <a class="btn" href="delete_product.php?id=<?php echo $row['id'] ?>">حذف</a></td>
                                                        </tr>
                                                <?php } ?>
                                            </tr>
                                        </tbody>
