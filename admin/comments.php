                                        ...
                                        <table class="table table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th> موبایل کاربر</th>
                                                    <th>نظر کاربر </th>
                                                    <th>تایید نظر / حذف نظر </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                                $comments = mysqli_query($db, "SELECT * FROM usermmessages WHERE is_confirm ='0' ORDER BY id DESC");
                                                while ($row = mysqli_fetch_array($comments)) { ?>
                                                        <tr>
                                                            ...
                                                            <td> <a class="btn" href="confirm_comment.php?id=<?php echo $row['id'] ?>">تایید نظر</a>
                                                            <a class="btn" href="delete_comment.php?id=<?php echo $row['id'] ?>">حذف نظر</a> </td>
                                                        </tr>
