...
$query = mysqli_query($db, "SELECT * FROM products ORDER BY id  ");

$get_cart_items = mysqli_query($db, "SELECT * FROM cart WHERE user_id='$name'");
$cart_items = mysqli_query($db, "SELECT * FROM cart WHERE user_id='$name'");
?>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body table-responsive p-0">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        <?php
                                        while ($row = mysqli_fetch_array($get_cart_items)) {
                                        $id = $row['product_id'];
                                        $get_product_name = mysqli_query($db, "SELECT * FROM products WHERE id='$id'");
                                        $product = mysqli_fetch_array($get_product_name);
                                        ?>
                                    <tr>
                                        ...
                                        <td><a class="btn" href="../config/delete_from_cart.php?product_id=<?php echo  $product['id'] ?>">حذف</a></td>
                                ...
                                <div>
                                    ...
                                    <form action="../config/pay.php" method="post">
                                        ...
                                        ?>" name="product-ids">
                                        <input class="btn" type="submit" value="اتصال به درگاه پرداخت">
                                    </form>
                                </div>
